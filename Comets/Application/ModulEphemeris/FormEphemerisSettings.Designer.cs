namespace Comets.Application.ModulEphemeris
{
	partial class FormEphemerisSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.timespanControl = new Comets.Application.Controls.ModulEphemeris.TimespanControl();
			this.outputDataControl = new Comets.Application.Controls.ModulEphemeris.OutputDataControl();
			this.requirementsControl = new Comets.Application.Controls.ModulEphemeris.RequirementsControl();
			this.SuspendLayout();
			// 
			// btnOk
			// 
		...
		private Comets.Application.Controls.Common.SelectCometControl selectCometControl;
		private Comets.Application.Controls.Common.ModeControl modeControl;
		private Controls.ModulEphemeris.TimespanControl timespanControl;
		private Controls.ModulEphemeris.OutputDataControl outputDataControl;
		private Controls.ModulEphemeris.RequirementsControl requirementsControl;
	}
}