namespace Comets.Application.ModulGraph
{
	partial class FormGraphSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.valueRangeControl = new Comets.Application.Controls.ModulGraph.ValueRangeControl();
			this.timespanControl = new Comets.Application.Controls.ModulGraph.TimespanControl();
			this.chartOptionsControl = new Comets.Application.Controls.ModulGraph.ChartOptionsControl();
			this.chartTypeControl = new Comets.Application.Controls.ModulGraph.ChartTypeControl();
			this.modeControl = new Comets.Application.Controls.Common.ModeControl();
			this.selectCometControl = new Comets.Application.Controls.Common.SelectCometControl();
			this.SuspendLayout();
			// 
			// btnOk
			// 
		...
		private Controls.Common.SelectCometControl selectCometControl;
		private Controls.Common.ModeControl modeControl;
		private Controls.ModulGraph.ChartTypeControl chartTypeControl;
		private Controls.ModulGraph.ChartOptionsControl chartOptionsControl;
		private Controls.ModulGraph.TimespanControl timespanControl;
		private Controls.ModulGraph.ValueRangeControl valueRangeControl;
	}
}