...
TFrame01 *Frame01;
//---------------------------------------------------------------------------
__fastcall TFrame01::TFrame01(TComponent* Owner)
	: TFrame(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFrame01::Button1Click(TObject *Sender)
{
	...
	if(Form1->Frame1->ComboBox1->ItemIndex == 18)
		Form1->Frame2->CheckBox8->Visible = true;
	else
...
void __fastcall TFrame01::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TFrame01::RadioButton2Click(TObject *Sender)
{
	Edit1->Enabled = true;
...
void __fastcall TFrame01::Button3Click(TObject *Sender)
{
	...
	if(ComboBox1->ItemIndex != 18)
		downloadedFile = Form1->dataFolder + "\\Soft" +
	...
	else downloadedFile = Form1->dataFolder + "\\ELEMENTS_"
					+ year + "-" +
					FormatFloat("00", mon) + "-" +
					FormatFloat("00", day) + "_" +
					FormatFloat("00", hour) + "-" +
...
void __fastcall TFrame01::Button4Click(TObject *Sender)
{
...
void __fastcall TFrame01::ComboBox1Change(TObject *Sender)
{
...
void __fastcall TFrame01::H1WorkBegin(TObject *ASender, TWorkMode AWorkMode,
...
void __fastcall TFrame01::H1Work(TObject *ASender, TWorkMode AWorkMode, __int64 AWorkCount)
{
...
void TFrame01::setDetectedComets(){
...
int TFrame01::getImportType(FILE *fin){
