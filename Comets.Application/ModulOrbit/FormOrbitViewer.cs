...
using CenteredObjectEnum = Comets.OrbitViewer.OrbitPanel.CenteredObjectEnum;
using OrbitsEnum = Comets.OrbitViewer.OrbitPanel.OrbitsEnum;

namespace Comets.Application.ModulOrbitViewer
{
